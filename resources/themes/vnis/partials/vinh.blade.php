<div class="popular-post-wrap">
        <h4 class="title vinh">Dá»ŠCH Vá»¤ AN TOÃ€N THÃ”NG TIN</h4>
            ...
            <div class="col-lg-6 single-popular-post">
                <div class="feature-img-wrap relative">
                    <div class="feature-img relative">
                        ...
                        <img class="img-fluid" src="@if(!isset($dichvu[$i]->image)){{ 'vnis/img/no-img/no-img-medium2.jpg' }}@else{{Voyager::image($dichvu[$i]->thumbnail('medium2'))}}@endif" alt="">
                    </div>
                    <ul class="tags">
                ...
                <div class="details">
                    <a href="/{{$dichvu[$i]->category->slug}}/{{$dichvu[$i]->slug}}">
                        <h4 class="tieu-de-top22">{{$dichvu[$i]->title}}</h4>
                    </a>
                    <ul class="meta">
