...
@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i>Thêm bài viết
        ...
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.posts.update', $dataTypeContent->id) }}@else{{ route('voyager.posts.store') }}@endif" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel" >
                            <div class="panel-heading">
                                    <h3 class="panel-title">
                                        ...
                                        {{-- <i class="voyager-character"></i>  {{ __('voyager::post.category') }}--}} 
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Trích dẫn của bài viết
                                {{-- {!! __('voyager::post.excerpt') !!} --}}
                            </h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Nội dung bài viết
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Hình ảnh bài viết
                                {{-- <i class="icon wb-image"></i> {{ __('voyager::post.image') }} --}}
                            </h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
